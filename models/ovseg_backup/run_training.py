...
from ovseg.model.model_parameters_segmentation import (
    get_model_params_3d_res_encoder_U_Net,
)
import argparse
...
assert preprocessed_name in ["pod_om", "abdominal_lesions", "lymph_nodes"], (
    "Unkown model"
)
...
if preprocessed_name == "pod_om":
    ...
    out_shape = [[20, 128, 128], [22, 152, 152], [30, 192, 192], [32, 216, 216]]
...
model_params = get_model_params_3d_res_encoder_U_Net(
    patch_size,
...
model_params["training"]["num_epochs"] = 100  # Set number of epochs here
